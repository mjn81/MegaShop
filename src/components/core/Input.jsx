...
export const Input = ({type="text" , placeHolder , id=null , name=null }) => {
    return (
        <input type={type} id={id ? id : ""} name={name ? name : ""}
               className='block bg-gray-100 py-4 px-6 w-full rounded-xl focus:bg-white
...
export const SearchInput = () => {
    return (  
        <div className="relative w-full">
            ...
            <input type="search" className=' bg-gray-100 py-4 px-12 w-full text-lg lg:w-4/6 rounded-xl
            focus:bg-white focus:drop-shadow-md focus:outline-none text-gray-600'
